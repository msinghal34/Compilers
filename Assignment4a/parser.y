...
DO_WHILE_STATEMENT		: DO '{' STATEMENT_LIST '}' WHILE '(' COND_EXP ')' ';'

WHILE_STATEMENT			: WHILE '(' COND_EXP ')' '{' STATEMENT_LIST '}'
						| WHILE '(' COND_EXP ')' STATEMENT

IF_STATEMENT			: IF '(' COND_EXP ')' '{' STATEMENT_LIST '}'
						| IF '(' COND_EXP ')' STATEMENT

BALANCED_IF_STATEMENT 	: ASSIGN_STATEMENT
						| DO_WHILE_STATEMENT
						| WHILE '(' COND_EXP ')' '{' STATEMENT_LIST '}'
						| WHILE '(' COND_EXP ')' BALANCED_IF_STATEMENT
						| IF '(' COND_EXP ')' '{' STATEMENT_LIST '}' ELSE '{' STATEMENT_LIST '}'
						| IF '(' COND_EXP ')' BALANCED_IF_STATEMENT ELSE '{' STATEMENT_LIST '}'
						| IF '(' COND_EXP ')' BALANCED_IF_STATEMENT ELSE BALANCED_IF_STATEMENT
						| IF '(' COND_EXP ')' '{' STATEMENT_LIST '}' ELSE BALANCED_IF_STATEMENT

IF_ELSE_STATEMENT 		: IF '(' COND_EXP ')' '{' STATEMENT_LIST '}' ELSE '{' STATEMENT_LIST '}'
						| IF '(' COND_EXP ')' BALANCED_IF_STATEMENT ELSE '{' STATEMENT_LIST '}'
						| IF '(' COND_EXP ')' BALANCED_IF_STATEMENT ELSE STATEMENT
						| IF '(' COND_EXP ')' '{' STATEMENT_LIST '}' ELSE STATEMENT
